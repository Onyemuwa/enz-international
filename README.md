...
en/  sw/  fr/  zh/    One real folder per language — 20 pages each:
...
For a sweeping change that touches most or all of the 80 pages at once (e.g. a full copy rewrite, a new
