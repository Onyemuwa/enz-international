...
export const industries = [
  ...
  { icon: 'globe', name: 'Consumer goods & retail', body: 'Household products and general merchandise.', considerations: ['Tighter AQL limits — defects reach end customers directly', 'Packaging and labelling compliance for the destination market', 'Seasonal lead-time planning around Chinese New Year'] },
  ...
  { icon: 'check', name: 'Agriculture & food processing', body: 'Post-harvest processing, milling and packaged-food production equipment.', considerations: ['Food-contact material certification for the destination market', 'Hygienic design and cleaning-in-place requirements', 'Seasonal raw-material supply and storage capacity'] },
  { icon: 'image', name: 'Packaging & printing', body: 'Flexible packaging, labelling and print-finishing equipment for branded goods.', considerations: ['Ink and substrate compliance for food or pharma packaging', 'Colour-matching consistency across production runs', 'Minimum order quantities on custom print tooling'] },
  { icon: 'award', name: 'Textiles & apparel', body: 'Fabric production and garment manufacturing equipment.', considerations: ['Fabric shrinkage and colourfastness testing before bulk production', 'Compliance labelling for the destination market', 'Cutting capacity versus order lead time'] },
];
