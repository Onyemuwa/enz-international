...
const dict = {
  en: {
    ...
    equipmentTitle: 'Machinery we source from China, for the world',
    equipmentLead: 'Whatever the machine, if it is made in China, we can find, vet and commission it — examples below, not a fixed inventory.',
    equipmentDisclaimer: 'We source against your brief and specification, worldwide. These are common categories and typical ranges, not listings of specific verified units — tell us the machine and the destination and we will quote it.',
    equipmentSpecPower: 'Power',
    ...
    equipmentCountTypes: 'types',
    qcEyebrow: 'Quality control',
    qcTitle: 'Four inspection points, not one',
    qcLead: 'Catch a defect while it can still be fixed, not after it ships.',
    ...
    ctaBannerDesc: 'A free 30-minute call. If it is not a fit, we say so.',
    ...
    handoverPick: 'Choose an Incoterm',
    handoverCost: 'Seller\'s cost',
    handoverRisk: 'Seller\'s risk',
    handoverYours: 'Yours',
    handoverEyebrow: 'Handover',
    handoverTitle: 'Where responsibility actually passes',
    handoverLead: 'Cost and risk do not always transfer at the same point. Pick a term and see.',
    ...
    heroOrigin: 'Sourced in Guangzhou, China — shipped worldwide',
    heroTitleA: 'We find your factory in China.',
    heroTitleB: 'And make sure it delivers.',
    heroSub: 'Verified suppliers, four inspection stages, freight to your port. One contact throughout.',
    ...
    problemLead: 'Four reasons, and none of them are bad luck.',
    commitEyebrow: 'Our commitments',
    commitTitle: 'What you can hold us to',
    commitLead: 'Specific things we do on every engagement, that you can check.',
    ...
    engageLead: 'Pick how much of the process we own. Start small, move up.',
    ...
    startLead: 'No commitment before the written scope.',
    whoEyebrow: 'Who we work with',
    whoTitle: 'Industries and markets we serve',
    whoLead: 'The categories we source most, and where we deliver.',
    ...
    pricingFactorsLead: 'Quoted after a scoping call, because these four vary too much to publish.',
    ...
    resourcesGuideLead: 'Costs, payment, timelines, and the mistakes that cost the most.',
  ...
  sw: {
    ...
    qcLead: 'Gundua kasoro ikiwa bado inaweza kurekebishwa, si baada ya kusafirishwa.',
    ...
    ctaBannerDesc: 'Simu ya bure ya dakika 30. Kama haifai, tutasema.',
    ...
    backToTop: 'Rudi juu',
    handoverPick: 'Chagua Incoterm',
    handoverCost: 'Gharama ya muuzaji',
    handoverRisk: 'Hatari ya muuzaji',
    handoverYours: 'Yako',
    handoverEyebrow: 'Makabidhiano',
    handoverTitle: 'Wapi jukumu linakabidhiwa kweli',
    handoverLead: 'Gharama na hatari hazikabidhiwi mahali pamoja kila wakati. Chagua neno uone.',
    ...
    heroSub: 'Wasambazaji waliothibitishwa, hatua nne za ukaguzi, usafirishaji hadi bandarini. Mtu mmoja tangu mwanzo hadi mwisho.',
    ...
    problemLead: 'Sababu nne, na hakuna hata moja ni bahati mbaya.',
    commitEyebrow: 'Ahadi zetu',
    commitTitle: 'Mambo unayoweza kutuwajibisha',
    commitLead: 'Mambo mahususi tunayofanya kila mradi, unayoweza kuthibitisha.',
    ...
    engageLead: 'Chagua kiasi cha mchakato tunachomiliki. Anza kidogo, panda juu.',
    ...
    startLead: 'Hakuna ahadi kabla ya maelezo ya maandishi.',
    whoEyebrow: 'Tunaofanya nao kazi',
    whoTitle: 'Sekta na masoko tunayohudumia',
    whoLead: 'Kategoria tunazonunua zaidi, na tunapowasilisha.',
    ...
    pricingFactorsLead: 'Hunukuliwa baada ya simu ya tathmini, kwa sababu haya manne hutofautiana mno.',
    ...
    resourcesGuideLead: 'Gharama, malipo, muda, na makosa yanayogharimu zaidi.',
  ...
  fr: {
    ...
    qcLead: 'Détecter un défaut tant qu\'il est corrigeable, pas après l\'expédition.',
    ...
    ctaBannerDesc: 'Un appel gratuit de 30 minutes. Si cela ne colle pas, nous le disons.',
    ...
    handoverPick: 'Choisissez un Incoterm',
    handoverCost: 'Coût vendeur',
    handoverRisk: 'Risque vendeur',
    handoverYours: 'À votre charge',
    handoverEyebrow: 'Transfert',
    handoverTitle: 'Où la responsabilité passe réellement',
    handoverLead: 'Le coût et le risque ne passent pas toujours au même point. Choisissez un terme.',
    ...
    heroSub: 'Fournisseurs vérifiés, quatre étapes d\'inspection, fret jusqu\'à votre port. Un seul interlocuteur.',
    ...
    problemLead: 'Quatre raisons, et aucune n\'est de la malchance.',
    commitEyebrow: 'Nos engagements',
    commitTitle: 'Ce que vous pouvez exiger de nous',
    commitLead: 'Des actions précises sur chaque mission, que vous pouvez vérifier.',
    ...
    engageLead: 'Choisissez la part que nous prenons. Commencez petit, montez ensuite.',
    ...
    startLead: 'Aucun engagement avant le cahier des charges écrit.',
    whoEyebrow: 'Nos clients',
    whoTitle: 'Secteurs et marchés que nous servons',
    whoLead: 'Les catégories que nous sourçons le plus, et où nous livrons.',
    ...
    pricingFactorsLead: 'Chiffré après un appel de cadrage : ces quatre éléments varient trop.',
    ...
    resourcesGuideLead: 'Coûts, paiement, délais et les erreurs les plus chères.',
  ...
  zh: {
    ...
    ctaBannerDesc: '30 分钟免费通话。不合适，我们会直说。',
    ...
    handoverRisk: '卖方承担风险',
    handoverYours: '由你承担',
    handoverEyebrow: '责任转移',
    handoverTitle: '责任究竟在哪一步转移',
    handoverLead: '费用与风险并不总在同一步转移。选一个术语看看。',
    founderEyebrow: '与谁合作',
    founderTitle: '创始人的话',
    ...
    resourcesGuideLead: '成本、付款、周期，以及代价最高的错误。',
