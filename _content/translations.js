...
const dict = {
  en: {
    ...
    equipmentTitle: 'Equipment we help you source',
    equipmentLead: 'Examples of what buyers in each industry typically ask us to find, vet and commission — not a fixed inventory.',
    equipmentDisclaimer: 'We source against your brief and specification. These are common categories and typical ranges, not listings of specific verified units.',
    equipmentSpecPower: 'Power',
    equipmentSpecCapacity: 'Typical capacity',
    equipmentSpecLeadTime: 'Typical lead time',
    equipmentRequestCta: 'Request this sourced',
