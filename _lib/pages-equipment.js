...
export function productCard(lang, item) {
  ...
  // every one of 29 cards by default is 200 lines of dense text standing
...
export function equipmentPage(lang) {
  ...
  // menu, and genuinely useful once the page holds dozens of products: nobody should
  ...
  <section class="section-sm bg-white pt-0">
    <div class="${SHELL} max-w-6xl space-y-6">
      ...
      <!-- Client-side only: filters the cards already on the page as the
